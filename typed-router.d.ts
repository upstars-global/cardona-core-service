...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'demo-components-demo-form': RouteRecordInfo<'demo-components-demo-form', '/demo/_components/DemoForm', Record<never, never>, Record<never, never>>,
    'demo-create': RouteRecordInfo<'demo-create', '/demo/create', Record<never, never>, Record<never, never>>,
    'demo-list': RouteRecordInfo<'demo-list', '/demo/list', Record<never, never>, Record<never, never>>,
    'demo-update': RouteRecordInfo<'demo-update', '/demo/update', Record<never, never>, Record<never, never>>,
    ...
    'permission-components-group-fragment-settings': RouteRecordInfo<'permission-components-group-fragment-settings', '/permission/_components/GroupFragmentSettings', Record<never, never>, Record<never, never>>,
    'permission-components-group-fragment-settings-table': RouteRecordInfo<'permission-components-group-fragment-settings-table', '/permission/_components/GroupFragmentSettingsTable', Record<never, never>, Record<never, never>>,
    'permission-components-section-form': RouteRecordInfo<'permission-components-section-form', '/permission/_components/SectionForm', Record<never, never>, Record<never, never>>,
    'permission-form': RouteRecordInfo<'permission-form', '/permission/form', Record<never, never>, Record<never, never>>,
