...
watch(
  () => props.isEdit,
  (value) => {
    if (props.disableAcceptUpdate) return
...
const setUpdate = (): void => {
  ...
  if (!props.disableAcceptUpdate) setEditMode(false)
...
<template>
  <div class="editable-wrapper" @click.stop>
    <div v-if="!openEdit" class="d-flex justify-content-center align-items-center">
      <div v-if="canEdit" class="icon-edit-wrapper mr-1">
        <feather-icon :icon="IconsList.EditIcon" @click.stop="setEditMode(true)" />
      </div>
    ...
    <div v-else class="d-flex justify-content-center align-items-center">
      ...
      <div class="action-buttons d-flex pl-50">
        <div class="cursor-pointer text-success" @click.stop="setUpdate">
