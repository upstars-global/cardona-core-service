  ...
  <section id="description-list-alignment">
    ...
    <b-row class="match-height">
      ...
      <b-col cols="12">
        <b-card>
          <b-card-title
            >Description lists <small class="text-muted">Horizontal</small></b-card-title
          >
          <b-card-text>
...
<script>
import { BRow, BCol, BCard, BCardTitle, BCardText, BCardHeader, BCardBody } from 'bootstrap-vue'
