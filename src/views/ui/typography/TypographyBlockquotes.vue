  ...
  <section id="blockquotes">
    <b-row class="match-height">
      ...
      <b-col md="6">
        <b-card no-body>
          <b-card-header>
            <b-card-title> Blockquotes <small class="text-muted">Default</small> </b-card-title>
          </b-card-header>
          <b-card-body>
            <b-card-text>
      ...
      <b-col md="6">
        <b-card no-body>
          <b-card-header>
            <b-card-title> Naming a source <small class="text-muted">Default</small> </b-card-title>
          </b-card-header>
          <b-card-body>
            <b-card-text>
              Add a
              <code class="highlighter-rouge">&lt;footer class="blockquote-footer"&gt;</code> for
        ...
        <b-card>
          ...
          <b-card-text>
            ...
            <code class="highlighter-rouge"
              >.border-{left/right}-{color} .border-{left/right}-3</code
            >
      ...
      <b-col md="6">
        <b-card>
          ...
          <b-card-text>
            Blockquotes with avatar. it use Media Object. You can customize image type, border
            alignment &amp; style.
          </b-card-text>
          <blockquote class="blockquote pl-1 border-left-primary border-left-3">
            <b-media no-body>
          ...
          <b-card-text class="mt-2"> Blockquotes with avatar rounded image example </b-card-text>
