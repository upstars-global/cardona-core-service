<template>
  <section id="lists">
    <div class="group-area mt-1">
      <h4>Lists</h4>
      <p>
        All lists - <code>&lt;ul&gt;</code>, <code>&lt;ol&gt;</code>, and <code>&lt;dl&gt;</code> -
        have their margin-top removed and a <code>margin-bottom: 1rem</code>. Nested lists have no
    ...
    <b-row class="match-height">
      ...
      <b-col md="4">
        <b-card title="Lists Unstyled">
          <b-card-text>
            ...
            <code class="highlighter-rouge">list-style</code> and left margin on list items
      ...
      <b-col md="4">
        <b-card>
          <b-card-title> Lists Unordered <small class="text-muted">Default</small> </b-card-title>
          <b-card-text>
            List of items in which the order does not explicitly matter. Use
            <code>.list-style-circle</code> or <code>.list-style-square</code> class in unordered
            list to add circle or square bullet points.
          </b-card-text>
          <ul>
            <li>Lorem ipsum dolor sit amet</li>
            <li>Consectetur adipiscing elit</li>
      ...
      <b-col md="4">
        <b-card>
          ...
          <b-card-text>
            ...
            <code>&lt;ol type="1|a|A|i|I"&gt;</code>, The type attribute specifies the kind of
            marker to use in the list.
          </b-card-text>
          <ol>
            <li>Lorem ipsum dolor sit amet</li>
            <li>Consectetur adipiscing elit</li>
      ...
      <b-col md="6">
        <b-card title="Lists icons">
          <b-card-text>
            list of terms with icons, use <code>.list-style-icons</code> class. You can use any icon
            from Vuexy Admin icon types.
          </b-card-text>
      ...
      <b-col md="6">
        <b-card>
          ...
          <b-card-text>
            Remove a list’s bullets and apply some light <code>margin</code> with a combination of
            two classes, <code>.list-inline</code> and <code>.list-inline-item</code>.
          </b-card-text>
          <b-card-text>
