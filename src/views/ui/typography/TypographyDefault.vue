  ...
  <b-row class="match-height">
      ...
      <b-card no-body>
        ...
        <b-card-body class="pb-1">
          <b-card-text>
            ...
            when you want to match the font styling of a heading.
          </b-card-text>
        </b-card-body>
        ...
        <b-table-simple borderless>
          <b-thead head-variant="danger">
            <b-tr>
              <b-th>PREVIEW</b-th>
              <b-th class="text-right"> FONT SIZE </b-th>
            </b-tr>
          </b-thead>
          <b-tbody>
            <b-tr>
              <b-td><h1>H1 Heading</h1></b-td>
              <b-td class="text-right"> 2rem </b-td>
            </b-tr>
            <b-tr>
              <b-td><h2>H2 Heading</h2></b-td>
              <b-td class="text-right"> 1.714rem </b-td>
            </b-tr>
            <b-tr>
              <b-td><h3>H3 Heading</h3></b-td>
              <b-td class="text-right"> 1.5rem </b-td>
            </b-tr>
            <b-tr>
              <b-td><h4>H4 Heading</h4></b-td>
              <b-td class="text-right"> 1.286rem </b-td>
            </b-tr>
            <b-tr>
              <b-td><h5>H5 Heading</h5></b-td>
              <b-td class="text-right"> 1.07rem </b-td>
            </b-tr>
            <b-tr>
              <b-td><h6>H6 Heading</h6></b-td>
              <b-td class="text-right"> 1rem </b-td>
            </b-tr>
          </b-tbody>
        </b-table-simple>
      </b-card>
        ...
        <b-table-simple borderless>
          <b-thead head-variant="danger">
            <b-tr>
              ...
              <b-th class="text-right"> BOLD HEADINGS </b-th>
            </b-tr>
          </b-thead>
          <b-tbody>
            <b-tr>
    ...
    <b-col md="6">
      <b-card no-body>
        <b-card-header>
          <b-card-title
            >Customizing headings <small class="text-muted">Default</small></b-card-title
          >
        </b-card-header>
        <b-card-body class="pb-1">
          <b-card-text
      ...
      <b-card no-body>
        ...
        <b-card-body class="pb-1">
          <b-card-text>
            ...
            <code>.text-{colorName}</code> class with heading elements.
          </b-card-text>
        </b-card-body>
