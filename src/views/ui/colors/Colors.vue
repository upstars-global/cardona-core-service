<template>
  <b-row>
    <b-col cols="12">
      <!-- Default Colors -->
      <b-card title="Default Colors" class="background-color">
        <!-- alert -->
        ...
        <b-card-text class="mb-0">
          Use <code>.bg-{color}.bg-lighten-{1 | 2 | 3 | 4 | 5}</code> classes for lighten background
          color.
        </b-card-text>
        <div class="d-flex justify-content-start flex-wrap">
          <div
        ...
        <b-card-text class="mb-0">
          Use <code>.bg-{color}.bg-darken-{1 | 2 | 3 | 4}</code> classes for darken background
          color.
        </b-card-text>
        <div class="d-flex justify-content-start flex-wrap">
          <div
...
<script>
import { BCard, BAlert, BLink, BCardText, BRow, BCol } from 'bootstrap-vue'
