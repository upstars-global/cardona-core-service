<template>
  <b-card-code title="Button only mode">
    <b-card-text>
      <span>
        Fancy just a button that launches the timepicker dialog, or want to provide your own
        optional text input field? Use the
      </span>
      <code>button-only</code>
      <span>
        prop to render the timepicker as a dropdown button. The formatted time label will be
        rendered with the class
      </span>
      <code>sr-only</code>
