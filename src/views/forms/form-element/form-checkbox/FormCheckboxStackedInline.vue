<template>
  <b-card-code title="Inline and stacked checkboxes">
    <b-card-text>
      ...
      <span>
        to place each form control one over the other, or if using individual checkboxes not inside
        a
      </span>
      <code>&lt;b-form-checkbox-group&gt;</code>
      <span>, set the </span>
...
import { BFormCheckboxGroup, BFormCheckbox, BFormGroup, BCardText } from 'bootstrap-vue'
