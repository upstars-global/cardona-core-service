<template>
  <b-card-code title="Disabled and readonly states">
    ...
    <div>
      ...
      <!-- date picker -->
      <b-form-datepicker id="ex-disabled-readonly" :disabled="disabled" :readonly="readonly" />
    </div>
...
import { BFormDatepicker, BFormGroup, BFormRadio, BFormRadioGroup, BCardText } from 'bootstrap-vue'
