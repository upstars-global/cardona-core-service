<template>
  <b-card-code title="Internationalization">
    ...
    <div>
      ...
      <b-form-select id="example-locales" v-model="locale" :options="locales" class="mb-1" />

      <!-- start weekday -->
      <label for="example-weekdays">Start weekday:</label>
      <b-form-select id="example-weekdays" v-model="weekday" :options="weekdays" class="mb-1" />
