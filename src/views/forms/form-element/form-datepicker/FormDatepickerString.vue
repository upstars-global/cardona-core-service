<template>
  <b-card-code title="Date string format">
    <b-card-text>
      <span
        >To change format options of the displayed date text inside the component, e.g. in the
        header or placeholder, set the
      </span>
    ...
    <div>
      ...
      <label class="mt-2" for="datepicker-dateformat2">Short date format</label>
      <b-form-datepicker
