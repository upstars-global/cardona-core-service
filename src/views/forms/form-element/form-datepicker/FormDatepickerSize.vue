<template>
  <b-card-code title="Control sizing">
    <b-card-text>
      ...
      <code>'lg'</code>
      <span>
        for a larger form form control. Note this does not affect the size of the popup calendar
        dialog.</span
      >
    </b-card-text>
    ...
    <div>
      ...
      <b-form-datepicker id="datepicker-default" local="en" class="mb-2" today-variant="danger" />
