<template>
  <b-card-code title="Detecting new, invalid, and duplicate tags">
    <b-card-text>
      <span>The event </span>
      <code>tag-state</code>
      <span
        >will be emitted whenever new tags are entered into the new tag input element, tags that do
        not pass validation, or duplicate tags are detected. The event handler will receive three
    ...
    <div>
      ...
      />
      <b-card-text class="mt-2"> Tags: {{ tags }} </b-card-text>
