<template>
  <b-card-code title="Using custom form components">
    <b-card-text>
      The scope contains attributes and event handlers that can be directly bound to most custom
      inputs or select components.
    </b-card-text>
...
import { BFormTags, BFormTag, BFormGroup, BFormSelect, BCardText } from 'bootstrap-vue'
