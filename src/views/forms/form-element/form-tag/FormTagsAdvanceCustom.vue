<template>
  <b-card-code title="Advanced custom rendering usage">
    <b-card-text>
      ...
      <span>
        will not work with your custom input, or if you need greater control over tag creation, you
        can take advantage of the additional properties provided via the default slot's scope.
      </span>
    </b-card-text>
