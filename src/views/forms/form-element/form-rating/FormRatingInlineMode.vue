<template>
  <b-card-code title="Inline mode">
    <b-card-text>
      ...
      <span>
        occupies 100% width of the parent container. In some situations you may prefer the custom
        input to occupy on the space required for it's contents. Simply set the
      </span>
      <code>inline</code>
      <span> prop to </span>
      <code>true</code>
