<template>
  <b-card-code title="Readonly plain text">
    <b-card-text>
      ...
      <code>readonly</code>
      <span>
        as it will be set automatically) to remove the default form field styling and preserve the
        correct text size, margin, padding and height.
      </span>
    </b-card-text>

    <b-form-textarea id="textarea-plaintext" readonly :value="text" />
