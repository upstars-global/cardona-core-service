<template>
  <b-card-code title="Displayed rows">
    <b-card-text>
      ...
      <code>rows</code>
      <span>
        prop to the desired number of rows. If no value is provided to rows, then it will default to
        2.</span
      >
    </b-card-text>

    <b-form-textarea id="textarea-rows" placeholder="Tall textarea" rows="8" />
