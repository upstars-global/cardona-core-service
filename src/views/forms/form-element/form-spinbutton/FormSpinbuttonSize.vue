<template>
  <b-card-code title="Size">
    ...
    <div>
      ...
      <b-form-spinbutton id="sb-small" size="sm" placeholder="--" class="mb-1" />

      <label for="sb-default">Spin button - Default size</label>
      <b-form-spinbutton id="sb-default" placeholder="--" class="mb-1" />

      <label for="sb-large">Spin button - Large size</label>
      <b-form-spinbutton id="sb-large" size="lg" placeholder="--" class="mb-1" />
    </div>
