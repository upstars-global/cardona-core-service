<template>
  <b-card-code title="Locale">
    <b-card-text>
      <span>By default </span>
      <code>&lt;b-form-spinbutton&gt;</code>
      <span>
        will format the displayed number in the users browser default locale. You can change the
        localized formatting by specifying a locale (or array of locales) via the
      </span>
      <code>locale</code>
      <span> prop. </span>
    </b-card-text>
    ...
    <div>
      ...
      <b-form-select id="sb-locales" v-model="locale" :options="locales" />
      ...
      <b-form-spinbutton
        ...
        step="0.125"
      />
      <b-card-text class="mt-1"> Value: {{ value }} </b-card-text>
    </div>
