        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group label="Email" label-for="vi-email">
              <b-form-input id="vi-email" type="email" placeholder="john.doe@email.com" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Password" label-for="vi-password">
              <b-form-input id="vi-password" type="password" placeholder="Password" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Confirm Password" label-for="vi-c-password">
              <b-form-input id="vi-c-password" type="password" placeholder="Re-type Password" />
            </b-form-group>
          </b-col>
        </b-row>
      </tab-content>
        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group label="Address" label-for="vi-address">
              <b-form-input id="vi-address" placeholder="98 Borough bridge Road, Birmingham" />
            </b-form-group>
          </b-col>
          <b-col md="6">
        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group label="Twitter" label-for="vi-twitter">
              <b-form-input id="vi-twitter" placeholder="https://twitter.com/abc" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Facebook" label-for="vi-facebook">
              <b-form-input id="vi-facebook" placeholder="https://facebook.com/abc" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Google+" label-for="vi-google-plus">
              <b-form-input id="vi-google-plus" placeholder="https://plus.google.com/abc" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="LinkedIn" label-for="vi-linked-in">
              <b-form-input id="vi-linked-in" placeholder="https://linkedin.com/abc" />
            </b-form-group>
          </b-col>
        </b-row>
      </tab-content>
