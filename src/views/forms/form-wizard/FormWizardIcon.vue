    ...
    >
      ...
      <tab-content title="Personal Info" icon="feather icon-user">
        <b-row>
          ...
          <b-col md="6">
            <b-form-group label-for="i-first-name" label="First Name">
              <b-form-input id="i-first-name" placeholder="John" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Last Name" label-for="i-last-name">
              <b-form-input id="i-last-name" placeholder="Doe" />
            </b-form-group>
          </b-col>
          <b-col md="6">
          ...
          <b-col md="6">
            <b-form-group label="Language" label-for="i-language">
              <v-select
                id="i-language"
        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group label="Address" label-for="i-address">
              <b-form-input id="i-address" placeholder="98 Borough bridge Road, Birmingham" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Landmark" label-for="i-landmark">
              <b-form-input id="i-landmark" placeholder="Borough bridge" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Pincode" label-for="i-pincode">
              <b-form-input id="i-pincode" placeholder="658921" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label-for="i-city" label="City">
              <b-form-input id="i-city" placeholder="Birmingham" />
            </b-form-group>
          </b-col>
        </b-row>
      </tab-content>
        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group label="Twitter" label-for="i-twitter">
              <b-form-input id="i-twitter" placeholder="https://twitter.com/abc" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Facebook" label-for="i-facebook">
              <b-form-input id="i-facebook" placeholder="https://facebook.com/abc" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="Google+" label-for="i-google-plus">
              <b-form-input id="i-google-plus" placeholder="https://plus.google.com/abc" />
            </b-form-group>
          </b-col>
          <b-col md="6">
            <b-form-group label="LinkedIn" label-for="i-linked-in">
              <b-form-input id="i-linked-in" placeholder="https://linkedin.com/abc" />
            </b-form-group>
          </b-col>
        </b-row>
      </tab-content>
