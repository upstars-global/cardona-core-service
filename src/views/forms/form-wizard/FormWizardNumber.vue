          ...
          <b-row>
            ...
            <b-col md="6">
              <b-form-group label="Landmark" label-for="landmark">
                <validation-provider v-slot="{ errors }" name="Landmark" rules="required">
                  <b-form-input
                    id="landmark"
                    v-model="landMark"
                    :state="errors.length > 0 ? false : null"
          ...
          <b-row>
            ...
            <b-col md="6">
              <b-form-group label="Twitter" label-for="twitter">
                <validation-provider v-slot="{ errors }" name="Twitter" rules="required|url">
                  <b-form-input
                    id="twitter"
                    v-model="twitterUrl"
                    :state="errors.length > 0 ? false : null"
            ...
            <b-col md="6">
              <b-form-group label="Facebook" label-for="facebook">
                <validation-provider v-slot="{ errors }" name="Facebook" rules="required|url">
                  <b-form-input
                    id="facebook"
                    v-model="facebookUrl"
                    :state="errors.length > 0 ? false : null"
            ...
            <b-col md="6">
              <b-form-group label="Google+" label-for="google-plus">
                <validation-provider v-slot="{ errors }" name="Google+" rules="required|url">
                  <b-form-input
                    id="google-plus"
                    v-model="googleUrl"
                    :state="errors.length > 0 ? false : null"
            ...
            <b-col md="6">
              <b-form-group label="LinkedIn" label-for="linked-in">
                <validation-provider v-slot="{ errors }" name="LinkedIn" rules="required|url">
                  <b-form-input
                    id="linked-in"
                    v-model="linkedinUrl"
                    :state="errors.length > 0 ? false : null"
