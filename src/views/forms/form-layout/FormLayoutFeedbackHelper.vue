  ...
  <b-card-code title="Form Feedback helpers">
    <b-form @submit.prevent>
      <b-row>
        <!-- username -->
        <b-col cols="12">
          <b-form-group label="Username" label-for="fh-usename">
            <b-input-group class="input-group-merge">
              <b-input-group-prepend is-text>
                <feather-icon icon="UserIcon" />
              </b-input-group-prepend>
              <b-form-input id="fh-usename" placeholder="Username" />
            </b-input-group>
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12">
          <b-form-group label="Email" label-for="fh-email">
            <b-input-group class="input-group-merge">
              ...
              <b-form-input id="fh-email" type="email" placeholder="Email" />
            </b-input-group>
        ...
        <b-col cols="12">
          <b-form-group>
            <b-form-checkbox id="checkbox-8" name="checkbox-8" value="Remember_me">
              Remember me
            </b-form-checkbox>
          </b-form-group>
        </b-col>
