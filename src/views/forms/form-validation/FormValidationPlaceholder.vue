<template>
  <b-card-code title="Field Name Placeholder">
    <b-card-text
      >vee-validate offers simple interpolation mechanism for returned messages, you can use the
      {_field_} placeholder in your string and it will be replaced with your field name
      automatically:</b-card-text
    >
