<template>
  <b-card-code title="Validation Locale">
    <b-card-text
      >VeeValidate has built-in localization support for validation messages. Localization is opt-in
      and is not configured by default.</b-card-text
    >
    ...
    <b-button variant="primary" @click="switchLoc"> Switch Locale </b-button>
