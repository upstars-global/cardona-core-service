<template>
  <b-card-code title="Extended">
    ...
    <b-row>
      ...
      <!-- ciode -->
      <b-col md="6">
        <prism language="javascript" class="rounded mb-2">
          {{ codePositive }}
        </prism>
      </b-col>
    </b-row>
    ...
    <validation-observer ref="simpleRules">
      <b-form>
        <b-row>
          ...
          <b-col md="6">
            <b-form-group label="Enter Only Positive Number">
              <validation-provider v-slot="{ errors }" name="Number" rules="required|positive">
                <b-form-input
                  v-model="posNum"
                  :state="errors.length > 0 ? false : null"
        ...
        <!-- submit button -->
        <b-form-group>
          <b-button type="submit" variant="primary" @click.prevent="validationForm">
            Submit
          </b-button>
        </b-form-group>
      </b-form>
