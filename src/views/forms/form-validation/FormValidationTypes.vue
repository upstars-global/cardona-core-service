        ...
        <b-row>
          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider v-slot="{ errors }" rules="required|integer" name="Number">
                <b-form-input
                  v-model="number"
                  :state="errors.length > 0 ? false : null"
          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider v-slot="{ errors }" rules="required|alpha" name="Alpha">
                <b-form-input
                  v-model="Alphabetic"
                  :state="errors.length > 0 ? false : null"
          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider v-slot="{ errors }" rules="required|min:3" name="Min Character">
                <b-form-input
                  v-model="digitValue"
                  :state="errors.length > 0 ? false : null"
          ...
          <b-col md="6">
            <b-form-group>
              ...
              <validation-provider v-slot="{ errors }" rules="required|digits:3" name="Numeric">
                <b-form-input
                  v-model="digitValue2"
                  :state="errors.length > 0 ? false : null"
