<template>
  <b-card-code title="Right Aligned Bordered Media">
    ...
    <div class="media-list media-bordered">
      <b-media right-align class="text-right">
        <template #aside>
          <b-img
      ...
      <b-media right-align class="text-right">
        ...
        <b-card-text>
          Jelly chocolate cake lemon drops halvah dragée caramels jelly-o biscuit. Fruitcake jelly
          beans marzipan sesame snaps.Jelly beans cake chocolate cake gummi bears lollipop.
        </b-card-text>
      </b-media>
      ...
      <b-media right-align class="text-right">
        ...
        <b-card-text>
          Pudding marshmallow cheesecake. Chocolate cake apple pie jelly-o bear claw ice cream sugar
