  ...
  <b-card-code title="Popover Options">
    <div class="demo-inline-spacing">
      ...
      <b-popover target="popover-target-1" triggers="hover" no-fade>
        <template #title> Without Fade Animation </template>
        <span
          >Tart macaroon marzipan I love soufflé apple pie wafer. Chocolate bar jelly caramels
          jujubes chocolate cake gummies.</span
        >
      </b-popover>
      ...
      <b-popover target="popover-target-2" triggers="hover" :delay="delay">
        <template #title> Click Triggered </template>
        <span
          >Tart macaroon marzipan I love soufflé apple pie wafer. Chocolate bar jelly caramels
          jujubes chocolate cake gummies.</span
        >
