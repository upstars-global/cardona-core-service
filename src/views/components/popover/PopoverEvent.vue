  ...
  <b-card-code title="Popover Events">
    ...
    <div class="demo-inline-spacing">
      ...
      <b-popover
        ...
        @show="onShow"
      >
        <template #title> Show Event Popover </template>
        <span
          >Bonbon chocolate cake. Pudding halvah pie apple pie topping marzipan pastry marzipan
          cupcake.</span
        >
      </b-popover>
      ...
      <b-popover
        ...
        @shown="onShown"
      >
        <template #title> Shown Event Popover </template>
        <span
          >Bonbon chocolate cake. Pudding halvah pie apple pie topping marzipan pastry marzipan
          cupcake.</span
        >
      ...
      <b-popover
        ...
        @hide="onHide"
      >
        <template #title> Hide Event Popover </template>
        <span
          >Bonbon chocolate cake. Pudding halvah pie apple pie topping marzipan pastry marzipan
          cupcake.</span
        >
      ...
      <b-popover
        ...
        @hidden="onHidden"
      >
        <template #title> Hidden Event Popover </template>
        <span
          >Bonbon chocolate cake. Pudding halvah pie apple pie topping marzipan pastry marzipan
          cupcake.</span
        >
