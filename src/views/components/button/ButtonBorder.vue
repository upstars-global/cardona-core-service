<template>
  <b-card-code title="Border">
    ...
    <div class="demo-inline-spacing">
      ...
      <b-button v-ripple.400="'rgba(0, 207, 232, 0.15)'" variant="outline-info"> Info </b-button>
      <b-button v-ripple.400="'rgba(30, 30, 30, 0.15)'" variant="outline-dark"> Dark </b-button>
    </div>
