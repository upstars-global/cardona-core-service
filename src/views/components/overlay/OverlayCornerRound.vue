<template>
  <b-card-code title="Overlay corner rounding">
    <b-card-text>
      <span>
        By default, the overlay backdrop has square corners. If the content you are wrapping has
        rounded corners, you can use the
      </span>
      <code>rounded</code>
      <span>
        prop to apply rounding to the overlay's corners to match the obscured content's rounded
        corners.</span
      >
    </b-card-text>

    <div>
      <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" @click="show = !show">
        Toggle overlay
      </b-button>
