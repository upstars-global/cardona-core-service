<template>
  <b-card-code title="Form confirmation prompt and upload status">
    <b-card-text>
      ...
      <code>overlay</code>
      <span>
        slot to present the user with a prompt dialog, and once confirmed it shows a uploading
        status indicator. This example also demonstrates additional accessibility markup.
      </span>
    </b-card-text>
      ...
      <b-form class="position-relative" @submit.prevent="onSubmit">
        <b-form-group label="Name" label-for="form-name" label-cols-lg="2">
          <b-input-group>
            ...
            <b-form-input id="form-name" :disabled="busy" />
          </b-input-group>
        </b-form-group>
        <b-form-group label="Email" label-for="form-mail" label-cols-lg="2">
          <b-input-group>
            ...
            <b-form-input id="form-email" type="email" :disabled="busy" />
          </b-input-group>
        </b-form-group>
        <b-form-group label="Image" label-for="form-image" label-cols-lg="2">
          <b-input-group>
            ...
            <b-form-file id="form-image" :disabled="busy" accept="image/*" />
          </b-input-group>
        </b-form-group>
        ...
        <b-overlay :show="busy" no-wrap @shown="onShown" @hidden="onHidden">
          <template #overlay>
            <div v-if="processing" class="text-center p-3 bg-primary text-light rounded">
            ...
            >
              <b-card-text class="font-weight-bolder"> Are you sure? </b-card-text>
              <div class="d-flex">
                <b-button
