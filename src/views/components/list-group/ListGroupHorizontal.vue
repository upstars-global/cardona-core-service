  ...
  <b-card-code title="Horizontal">
    <b-card-text>
      ...
      <span
        ...
        breakpoints. Alternatively, set</span
      >
      <code>horizontal</code>
      <span>to a responsive breakpoint</span>
      <code>(sm, md, lg or xl)</code>
      <span>
        to make a list group horizontal starting at that breakpoint's min-width. Currently
        horizontal list groups cannot be combined with</span
      >
      <code>flush</code>
...
<script>
import { BListGroup, BListGroupItem, BCardText, BAlert } from 'bootstrap-vue'
