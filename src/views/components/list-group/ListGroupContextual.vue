<template>
  <b-card-code title="Contextual Classes">
    ...
    <b-list-group>
      <b-list-group-item variant="primary"> Pie fruitcake jelly-o </b-list-group-item>
      <b-list-group-item variant="secondary"> halvah icing marshmallow </b-list-group-item>
      <b-list-group-item variant="success">
        Cake caramels donut danish muffin biscuit
      </b-list-group-item>
      <b-list-group-item variant="danger"> Chocolate cake pie lollipop </b-list-group-item>
      <b-list-group-item variant="warning">
        Apple pie toffee pudding gummi bears
      </b-list-group-item>
      <b-list-group-item variant="info"> Jujubes chupa chups cheesecake tart </b-list-group-item>
