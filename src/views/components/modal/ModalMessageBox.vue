<template>
  <b-card-code title="Confirm message box">
    <b-card-text class="mb-0">
      ...
      <span>
        object. These methods provide a way to generate simple OK and Confirm style modal messages,
        from anywhere in your app without having to explicitly place a
      </span>
      <code>&lt;b-modal&gt;</code>
