<template>
  <b-card-code title="Modal Themes">
    ...
    <div class="demo-inline-spacing">
      ...
      <b-button v-ripple.400="'rgba(30, 30, 30, 0.15)'" v-b-modal.modal-dark variant="outline-dark">
        Dark
      </b-button>
    </div>
    ...
    >
      <b-card-text>
        ...
        Pudding caramels liquorice sweet I love. Donut powder cupcake ice cream tootsie roll jelly.
      </b-card-text>
    </b-modal>
