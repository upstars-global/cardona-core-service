<template>
  <b-card-code title="Variants">
    <b-card-text class="mb-0">
      ...
      Bootstrap v4 variant names. If you have custom SCSS defined Bootstrap color theme variants,
      the toast custom SCSS will automatically create toast variants for you (refer to the Theming
      reference section).
    </b-card-text>

    <div class="demo-inline-spacing">
      <!-- default -->
      <b-button variant="gradient-primary" @click="makeToast()"> Default </b-button>
