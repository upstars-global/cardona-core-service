<template>
  <b-card-code title="Toaster target">
    <b-card-text class="mb-0">
      <span
        >BootstrapVue comes with the following "built-in" toaster names (and associated styles
        defined in SCSS):
      </span>
      <code
        >b-toaster-top-right, b-toaster-top-left, b-toaster-top-center, b-toaster-top-full,
        b-toaster-bottom-right, b-toaster-bottom-left, b-toaster-bottom-center,
