<template>
  <b-card-code title="Links">
    <b-card-text>
      ...
      <code>&lt;nuxt-link&gt;</code>
      <span
        >) via the href and to props respectively. When set, the entire toast body becomes a
        link.</span
      >
    </b-card-text>

    <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="outline-primary" @click="toast()">
      Toast with link
    </b-button>
