<template>
  <b-card-code title="Advanced usage">
    <b-card-text>
      ...
      <span>
        method for generating toasts, you may want the toast content to be more than just a string
        message. As mentioned in the Toasts on demand section above, you can pass arrays of
      </span>
      <code>VNodes</code>
