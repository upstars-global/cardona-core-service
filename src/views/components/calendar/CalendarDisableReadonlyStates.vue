  ...
  <b-card-code title="Disabled and readonly states">
    ...
    <div class="d-flex justify-content-center">
      <div>
        ...
        <!-- calendar -->
        <b-calendar id="ex-disabled-readonly" :disabled="disabled" :readonly="readonly" />
      </div>
    </div>
...
import { BFormGroup, BFormRadioGroup, BFormRadio, BCalendar, BCardText } from 'bootstrap-vue'
