<template>
  <b-card-code title="Default slot">
    <b-card-text>
      <span
        >Provide optional content at the bottom of the calendar interface via the use of default
        slot. The slot can be used to add buttons such as
      </span>
    ...
    <div class="d-flex align-items-center justify-content-center">
      <b-calendar v-model="value" value-as-date locale="en">
        <div class="d-flex" dir="ltr">
          <b-button v-if="value" size="sm" variant="outline-secondary" @click="clearDate">
            Clear date
          </b-button>
