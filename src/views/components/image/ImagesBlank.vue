<template>
  <b-card-code title="Blank (or solid color) images">
    <b-card-text class="mb-0">
      <code>&lt;b-img&gt;</code>
      <span>
        provides built-in support for generating blank images (transparent by default) of any width
        and height, by setting the
      </span>
      <code>blank</code>
    ...
    <div class="demo-inline-spacing">
      <!--transparent img -->
      <b-img v-bind="mainProps" rounded alt="Transparent image" class="d-inline-block border" />
