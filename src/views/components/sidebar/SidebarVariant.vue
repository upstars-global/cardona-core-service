<template>
  <b-card-code title="Sidebar Variant">
    <b-card-text>
      ...
      <span>
        to control the theme color variant of the background and text, respectively. Alternatively,
        you can apply styles or classes to specify the background and text colors.
      </span>
    </b-card-text>
