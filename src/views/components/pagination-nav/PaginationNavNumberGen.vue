<template>
  <b-card-code title="Page number generation">
    <b-card-text>
      ...
      <span>
        renders page numbers (1-N) in the page link buttons. You can override this behaviour by
        supplying a function reference to the
      </span>
      <code>page-gen</code>
      <span> property.</span>
    </b-card-text>

    <b-pagination-nav :link-gen="linkGen" :page-gen="pageGen" :number-of-pages="links.length" />
