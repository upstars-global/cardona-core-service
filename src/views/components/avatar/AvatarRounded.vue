<template>
  <b-card-code title="Rounded">
    ...
    <div class="demo-inline-spacing">
      <b-avatar rounded="sm" variant="light-primary" />
      <b-avatar rounded variant="light-success" />
      <b-avatar rounded="top" variant="light-danger" />
      <b-avatar rounded="lg" variant="light-warning" />
      <b-avatar rounded="left" variant="light-info" />
      <b-avatar rounded="right" variant="light-primary" />
      <b-avatar rounded="bottom" variant="light-dark" />
    </div>
