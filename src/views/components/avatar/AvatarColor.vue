<template>
  <b-card-code title="Colors">
    ...
    <div class="demo-inline-spacing">
      ...
      <b-avatar variant="secondary" text="PI" />
      <b-avatar variant="success" text="PI" />
      <b-avatar variant="danger" text="PI" />
      <b-avatar variant="warning" text="PI" />
      <b-avatar variant="info" text="PI" />
    </div>
