<template>
  <b-card-code title="Badge positioning">
    ...
    <div class="demo-inline-spacing">
      <b-avatar class="mr-1" badge badge-variant="success" />
      <b-avatar class="mr-1" badge-variant="success" badge badge-left />
      <b-avatar badge class="mr-1" badge-variant="success" badge-top />
      <b-avatar badge class="mr-1" badge-variant="success" badge-left badge-top />
    </div>
