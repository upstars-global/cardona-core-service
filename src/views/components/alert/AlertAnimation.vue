<template>
  <b-card-code title="Alert Animation">
    ...
    <!-- dismissible alert -->
    <b-alert v-height-fade show dismissible fade class="mb-0" variant="primary">
    ...
    <div class="demo-inline-spacing mb-1">
      <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" @click="showAlert">
    ...
    <b-card-text class="m-0 py-1"> You can even use this on dismissible alerts. </b-card-text>
