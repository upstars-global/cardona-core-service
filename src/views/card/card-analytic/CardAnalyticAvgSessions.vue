  ...
  <b-card>
    <b-row class="pb-50">
      ...
      <b-col lg="6" order-lg="1" order="2" class="d-flex justify-content-between flex-column">
        <div class="mt-1 mt-lg-0">
          ...
          <b-card-text class="font-weight-bold mb-2"> Avg Sessions </b-card-text>
        ...
        <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" class="shadow">
          View Details
        </b-button>
      </b-col>
    ...
    <b-row class="avg-sessions pt-50">
      <b-col cols="6" class="mb-2">
        <b-card-text class="mb-50"> Goal: ${{ avgData.goal }} </b-card-text>
        <b-progress value="50" max="100" height="6px" />
      </b-col>
      <b-col cols="6" class="mb-2">
        <b-card-text class="mb-50"> Users: {{ kFormatter(avgData.users) }} </b-card-text>
        <b-progress value="60" max="100" height="6px" variant="warning" />
      </b-col>
      <b-col cols="6">
        <b-card-text class="mb-50"> Retention: {{ avgData.retention }}% </b-card-text>
        <b-progress value="70" max="100" height="6px" variant="danger" class="mt-25" />
      </b-col>
      <b-col cols="6">
        <b-card-text class="mb-50"> Duration: {{ avgData.duration }}yr </b-card-text>
        <b-progress value="90" max="100" variant="success" height="6px" class="mt-25" />
      </b-col>
    </b-row>
  </b-card>
</template>
