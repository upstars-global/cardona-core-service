<template>
  <b-card class="card-app-design">
    <b-badge variant="light-primary"> 03 Sep, 20 </b-badge>
    <b-card-title class="mt-1 mb-75"> App design </b-card-title>
    ...
    <div class="design-group">
      ...
      <b-badge variant="light-warning" class="mr-1"> Figma </b-badge>
      <b-badge variant="light-primary" class="ml-25"> Wireframe </b-badge>
    </div>
    <div class="design-group">
...
<script>
import { BCard, BBadge, BCardTitle, BCardText, BAvatar, BButton } from 'bootstrap-vue'
