  ...
  <section id="card-content-types">
    ...
    <b-row>
      <b-col md="6" lg="4">
        ...
        <b-card class="mb-4">
          <b-card-text>
            This is some text within a card body. Jelly lemon drops tiramisu chocolate cake cotton
            candy soufflé oat cake sweet roll. Sugar plum marzipan dragée topping cheesecake
            chocolate bar. Danish muffin icing donut.
          </b-card-text>
        </b-card>
