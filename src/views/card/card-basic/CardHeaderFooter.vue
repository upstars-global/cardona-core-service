<template>
  <div>
    ...
    <b-row>
      ...
      <!-- card 2 -->
      <b-col md="6" lg="4">
        <b-card header="Quote" header-tag="h6">
          <blockquote class="blockquote mb-0">
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a
              ante.Lorem ipsum dolor sit amet, Integer posuere erat a ante Integer posuere erat a
              anteconsectetur.
            </p>
      ...
      <b-col md="6" lg="4">
        ...
        >
          <b-card-text> With supporting text below as a natural. </b-card-text>
          <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="outline-primary">
            Go somewhere
          </b-button>
        </b-card>
