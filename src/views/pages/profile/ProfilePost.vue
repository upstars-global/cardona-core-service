<template>
  <div>
    <b-card v-for="data in posts" :key="data.avatar">
      <div class="d-flex justify-content-start align-items-center mb-1">
        <!-- avatar -->
        <b-avatar :src="data.avatar" size="50" class="mr-1" />
        <!--/ avatar -->
      ...
      <!-- post img -->
      <b-img v-if="data.postImg" fluid rounded class="mb-25" :src="data.postImg" />
      <!--/ post img -->
      <!-- post video -->
      <b-embed
        v-if="data.postVid"
      ...
      <b-row class="pb-50 mt-50">
        ...
        >
          ...
          <b-link class="text-body text-nowrap">
            <feather-icon icon="Share2Icon" size="18" class="profile-icon mr-50" />
