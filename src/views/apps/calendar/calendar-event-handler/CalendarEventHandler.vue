      ...
      <template #default="{ hide }">
        ...
        <validation-observer v-slot="{ handleSubmit }" ref="refFormObserver">
          ...
          <b-form class="p-2" @submit.prevent="handleSubmit(onSubmit)" @reset.prevent="resetForm">
            <!-- Title -->
            <validation-provider v-slot="validationContext" name="Title" rules="required">
            ...
            <!-- Calendar -->
            <validation-provider v-slot="validationContext" name="Calendar" rules="required">
              <b-form-group
                label="Calendar"
                label-for="calendar"
                :state="getValidationState(validationContext)"
            ...
            <!-- Event URL -->
            <validation-provider v-slot="validationContext" name="Event URL" rules="url">
