            ...
            <b-card-body class="invoice-padding pb-0">
              ...
              >
                ...
                <div>
                  ...
                  <b-card-text class="mb-25"> Office 149, 450 South Brand Brooklyn </b-card-text>
                  <b-card-text class="mb-25"> San Diego County, CA 91905, USA </b-card-text>
                  <b-card-text class="mb-0"> +1 (123) 456 7891, +44 (876) 543 2198 </b-card-text>
                </div>
                ...
                <div class="invoice-number-date mt-md-0 mt-2">
                  <div class="d-flex align-items-center justify-content-md-end mb-1">
                    ...
                    <b-input-group class="input-group-merge invoice-edit-input-group disabled">
                      ...
                      <b-form-input id="invoice-data-id" v-model="invoiceData.id" disabled />
                    </b-input-group>
                  </div>
                    ...
                    <div class="d-flex border rounded">
                      <b-row class="flex-grow-1 p-2">
                        ...
                        <b-col cols="12" lg="3">
                          ...
                          <b-form-input v-model="item.cost" type="number" class="mb-2" />
                        </b-col>
                        <b-col cols="12" lg="2">
                        ...
                        <b-col cols="12" lg="5">
                          ...
                          <b-form-textarea v-model="item.description" class="mb-2 mb-lg-0" />
                        </b-col>
                        <b-col>
            ...
            <b-card-body class="invoice-padding pb-0">
              <b-row>
                ...
                <b-col
                  ...
                  order-md="1"
                >
                  <label for="invoice-data-sales-person" class="text-nowrap mr-50"
                    >Sales Person:</label
                  >
                  <b-form-input
