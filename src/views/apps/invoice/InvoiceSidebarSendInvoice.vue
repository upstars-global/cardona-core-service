    ...
    <template #default="{ hide }">
      ...
      <b-form class="p-2" @submit.prevent>
        ...
        <b-form-group label="From" label-for="from">
          <b-form-input id="from" v-model="sendInvoiceData.from" trim type="email" />
        </b-form-group>

        <!-- To -->
        <b-form-group label="To" label-for="to">
          <b-form-input id="to" v-model="sendInvoiceData.to" trim type="email" />
        </b-form-group>
        ...
        <b-form-group label="Message" label-for="message">
          <b-form-textarea id="message" v-model="sendInvoiceData.message" rows="12" trim />
        </b-form-group>
