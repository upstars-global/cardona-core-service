      ...
      <b-card no-body>
        ...
        <b-card-body>
          <b-row>
            <!-- Full Name -->
            <b-col cols="12" md="6">
              <validation-provider v-slot="validationContext" name="Full Name" rules="required">
            ...
            <b-col cols="12" md="6">
              <validation-provider
                ...
                rules="required"
              >
                <b-form-group label="Flat, House No" label-for="flat-house-no" class="mb-2">
                  <b-form-input
                    id="flat-house-no"
            ...
            <!-- Landmark -->
            <b-col cols="12" md="6">
              <validation-provider v-slot="validationContext" name="Landmark" rules="required">
                <b-form-group label="Landmark" label-for="landmark" class="mb-2">
                  <b-form-input
                    id="landmark"
            ...
            <!-- City -->
            <b-col cols="12" md="6">
              <validation-provider v-slot="validationContext" name="Town/city" rules="required">
            ...
            <!-- state -->
            <b-col cols="12" md="6">
              <validation-provider v-slot="validationContext" name="State" rules="required">
            ...
            <!-- Address Type -->
            <b-col cols="12" md="6">
              <validation-provider v-slot="validationContext" name="Address Type" rules="required">
                <b-form-group
                  label="Address Type"
            ...
            <!-- Submit Button -->
            <b-col cols="12">
              <b-button variant="primary" type="submit"> Save and Deliver Here </b-button>
            </b-col>
          </b-row>
        </b-card-body>
      </b-card>
