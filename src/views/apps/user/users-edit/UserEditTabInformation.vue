      ...
      <b-row class="mt-1">
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Address Line 1" label-for="address-line-1">
            <b-form-input id="address-line-1" v-model="userDataInfo.addressLine1" />
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="State" label-for="state">
            <b-form-input id="state" v-model="userDataInfo.state" placeholder="Manhattan" />
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Country" label-for="country">
            <b-form-input id="country" v-model="userDataInfo.country" placeholder="United States" />
          </b-form-group>
        </b-col>
      </b-row>
