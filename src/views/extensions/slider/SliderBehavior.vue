<template>
  <b-card-code title="Slider behavior">
    ...
    <h6 class="mt-2">Drag on Click</h6>
    <b-card-text>
      <span>When </span>
    ...
    <!-- slider -->
    <vue-slider v-model="value1" :direction="direction" :drag-on-click="true" />

    <!-- process not filled slider -->
    <h6 class="mt-2">Process not filled</h6>
    <b-card-text>
      <span>User </span>
      <code>process</code>
    ...
    <!-- slider -->
    <vue-slider v-model="value2" :direction="direction" :process="false" />

    <!-- min and max slider -->
    <h6 class="mt-2">Min & Max</h6>
    <b-card-text>
      <span>Use </span>
      <code>min-range</code>
      <span> and </span>
    ...
    <!-- slider -->
    <vue-slider v-model="value3" :min-range="10" :direction="direction" :max-range="50" />

    <!-- fixed slider  -->
    <h6 class="mt-2">Fixed</h6>
    <b-card-text>
      <span>Use </span>]
      <code>fixed</code>
    ...
    <!-- slider -->
    <vue-slider v-model="value4" :direction="direction" :fixed="true" />
