<template>
  <b-card-code title="Disabled Slider">
    ...
    <!--disabled slider -->
    <vue-slider v-model="value1" :disabled="true" class="mb-2" :direction="direction" />

    <!-- disabled dot -->
    <vue-slider v-model="value2" :dot-options="dotOptions" :order="false" :direction="direction" />
