<template>
  <b-card-code title="Search Tree">
    ...
    <b-input-group class="mb-1">
      ...
      <b-form-input v-model.lazy="searchword" placeholder="Search..." @input="search" />
    </b-input-group>
    ...
    tpl(...args) {
      ...
      return (
        <span>
          <span
            class="tree-expand"
            onClick={() => this.$refs.tree.addNode(node, { title: 'sync node' })}
          >
            +
          </span>
          <span
          ...
          ></span>
          <button
            class="btn-async text-warning border-0 cursor-pointer mr-1"
