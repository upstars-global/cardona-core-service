<template>
  <b-card-code title="Basic Examples">
    <b-card-text class="mb-0">
      SweetAlert automatically centers itself on the page and looks great no matter if you're using
      a desktop computer, mobile or tablet. It's even highly customizable, as you can see below!
    </b-card-text>
