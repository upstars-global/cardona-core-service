<template>
  <b-card-code title="Multiple Lists">
    ...
    <b-row>
      <!-- people group 1 -->
      <b-col md="6">
        <h6 class="text-primary font-weight-bold mb-2">People Group 1</h6>
      ...
      <b-col md="6" class="mt-sm-2 mt-md-0">
        <h6 class="text-primary font-weight-bold mb-2">People Group 2</h6>
      ...
      <b-col md="6" class="mt-1">
        <prism language="javascript" class="rounded"> People Group 1: {{ list1 }} </prism>
      </b-col>

      <!-- people group 2 code -->
      <b-col md="6" class="mt-1">
        <prism language="javascript" class="rounded"> People Group 2: {{ list2 }} </prism>
      </b-col>
    </b-row>
