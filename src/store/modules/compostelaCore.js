...
export default {
    ...
    actions: {
        ...
        async getImagesList({ commit }, { pageNumber, perPage, search }) {
            const data = await ApiService.request({
        ...
        async getStructureList({ commit, dispatch }, { path, pageNumber, perPage, search, }) {
            if (search) {
...
//# sourceMappingURL=compostelaCore.js.map