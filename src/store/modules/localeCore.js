...
export default {
    ...
    getters: {
        ...
        allLocalesOptions: ({ allLocales }) => Object.entries(allLocales).map(([code, name]) => new LocaleOption(code, name)),
    },
    mutations: {
    ...
    actions: {
        async getLocalesList({ commit, getters }) {
            if (getters.allLocalesOptions.isNotEmpty)
                return;
...
//# sourceMappingURL=localeCore.js.map