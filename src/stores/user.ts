...
export const useUserStore = defineStore('user', {
  ...
  getters: {
    getSelectedProject: state => {
      ...
      const fromStorage = sessionStorage.getItem(`${storageKeys.selectedProjectId}-${productName}-${state.userInfo.id}`) || localStorage.getItem(`${storageKeys.selectedProjectId}-${productName}-${state.userInfo.id}`)
