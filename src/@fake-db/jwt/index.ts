    ...
    projects: [
      ...
      },
      {
        ...
        originProject: {
          ...
          locales: ['en', 'es', 'fr'],
          mainLocale: 'en',
          icon: { path: null, compostelaPath: '/svc/img/i/shared/projects/chromevnztIDiq_png', publicPath: '/svc/img/i/shared/projects/chromevnztIDiq_png' },
          id: 166,
          name: 'ThorDevelop3',
          alias: 'thor_develop3',
          iconPath: '/svc/img/i/shared/projects/chromevnztIDiq_png',
      ...
      },
      {
        id: 167,
        name: 'ThorDevelop4',
        publicName: 'ThorDevelop4',
        alias: 'thor_develop4',
        websiteUrl: 'https://rc.thor-develop.upstr.to',
        integrations: { valencia: true, marbella: false },
        iconPath: '/svc/img/i/shared/projects/chromevnztIDiq_png',
        productId,
        originProject: {
          integrations: { valencia: true, marbella: false },
      ...
      },
      {
        id: 168,
        name: 'ThorDevelop5',
        publicName: 'ThorDevelop5',
        alias: 'thor_develop5',
        websiteUrl: 'https://rc.thor-develop.upstr.to',
        integrations: { valencia: false, marbella: true },
        iconPath: '/svc/img/i/shared/projects/chromevnztIDiq_png',
        productId,
        originProject: {
          integrations: { valencia: false, marbella: true },
